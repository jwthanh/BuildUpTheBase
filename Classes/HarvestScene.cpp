...
void BaseScene::create_goal_loadingbar()
{
    ...
    auto progress_callback = [this]() {
            ...
            res_count_t target_level = target_building->get_building_level() + 1.0;
            res_count_t coin_goal = get_building_upgrade_cost(target_building->type, target_level);
...
void BaseScene::create_info_panel()
{
    ...
    ui::TextBMFont* arena_kill_lbl = dynamic_cast<ui::TextBMFont*>(arena_kill_panel->getChildByName("arena_kill_lbl"));
    ...
    set_horizontal_center_align(building_name);
        ...
        if (hp->current_val != hp_cache->last_cur_hp)
        {
            ...
            player_hp_lbl->setString(hp_ss.str());
                ...
                if (hp->is_empty()) {
                    ...
                    run_flash_action(player_hp_lbl, 0.15f, 1.2f, 1.0f, start_color, Color3B::WHITE);
                }
    ...
    auto update_listview = [this, inventory_basic_listview, inventory_advanced_listview](float dt)
    {
        ...
        for (auto&& type_and_count : ingredient_counts)
        {
            ...
            auto update_lbl_cb = [new_item_panel, ing_type](float)
            {
                ...
                ui::TextBMFont* item_count_lbl = dynamic_cast<ui::TextBMFont*>(new_item_panel->getChildByName("item_count_lbl"));
...
ui::Widget* BaseScene::create_ingredient_detail_alert(Ingredient::SubType ing_type)
{
    ...
    auto resource_name = dynamic_cast<ui::TextBMFont*>(alert_panel->getChildByName("resource_name"));
    ...
    set_horizontal_center_align(resource_description);
    ...
    auto value_lbl = dynamic_cast<ui::TextBMFont*>(alert_panel->getChildByName("value_lbl"));
