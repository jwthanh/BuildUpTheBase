...
#include "magic_particles\opengl\mp_config.h"
...
public:
	...
	void SetCamera(MP_POSITION& eye, MP_POSITION& at, MP_POSITION& up);
	#endif
};
...
struct MP_MATRIX
{
	...
	// eng: Calculation of orthogonal projection (analogue of glOrtho from OpenGL) 
	// rus: Расчет матрицы ортогональной проекции (аналог glOrtho из OpenGL)
...
public:
	...
	// rus: Настройка сцены
	virtual void SetScene3d(bool camera_mode){this->camera_mode=camera_mode;};
	// eng: Camera position
	// rus: Положение камеры
